...
function WhatsappButton({ product }) {
    _s();
    const searchParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"])();
    // Descobre qual variação está selecionada pelos filtros na página (cor, tipo, etc.)
    const selectedVariant = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$experimental$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "WhatsappButton.useMemo[selectedVariant]": ()=>{
            return product.variants.find({
                "WhatsappButton.useMemo[selectedVariant]": (variant)=>variant.selectedOptions.every({
                        "WhatsappButton.useMemo[selectedVariant]": (option)=>searchParams.get(option.name) === option.value
                    }["WhatsappButton.useMemo[selectedVariant]"])
            }["WhatsappButton.useMemo[selectedVariant]"]);
        }
    }["WhatsappButton.useMemo[selectedVariant]"], [
    ...
    const message = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$experimental$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "WhatsappButton.useMemo[message]": ()=>{
            const lines = [
                `Olá! Tenho interesse no produto:`,
                `*${product.title}*`
            ];
            if (variant) {
                lines.push(`Variação: ${variant.title}`);
            }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$experimental$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
        ...
        className: `relative flex w-full items-center justify-center rounded-full bg-green-600 p-4 tracking-wide text-white ${disabled ? "cursor-not-allowed opacity-60" : "hover:opacity-90"}`,
        children: disabled ? "Fora de estoque" : "Pedir pelo WhatsApp"
    }, void 0, false, {
...
_s(WhatsappButton, "2q7vr5KWAIrsqzWrNV4b7WBJT6I=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"]
    ];
});
...
//# sourceMappingURL=components_15ffdd4d._.js.map